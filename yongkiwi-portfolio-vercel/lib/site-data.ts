...
export const projects: Project[] = [
  ...
  },
  {
    ...
    execution: [
      ...
      "기술적 작동 문제와 블로그 노출 로직 변화를 구분해 서로 다른 대응·검증 주기로 관리했습니다.",
    ],
    evidence: [
    ...
    proofs: [
      ...
      },
      {
        title: "플랫폼 변경 대응 기록",
        description:
          "변경 감지, 영향 범위, 수정 내용, 정상화 시점과 후속 검증을 기록한 운영 이력이 들어갈 자리입니다.",
        captureGuide:
          "실제 고객 정보를 제거한 변경 대응표를 준비해 주세요. 기술적 작동 변경과 블로그 노출 로직 변경을 구분하고, 감지일·수정일·후속 검증 결과가 보이면 좋습니다.",
      },
    ],
    measurement:
    ...
    learning:
      "시스템 오너십은 프로그램을 만든 순간이 아니라 실제 업무에서 계속 성과를 내도록 운영할 때 완성됩니다. 문제를 가장 가까이에서 겪는 실무자가 개선 기준과 필요한 결과를 정의하고, 변화에 맞춰 끝까지 고도화할 때 작은 내부 도구도 조직의 일하는 방식을 바꿀 수 있습니다.",
  },
];
