...
export const projects: Project[] = [
  {
    ...
    decisionCase: {
      ...
      title: "병목을 직접 분석해, 고객별 변형까지 대량 처리하는 통합앱을 만들었습니다.",
      description:
        "별도 지시 없이 수작업 전체 흐름을 분석하고 필요한 프로그램을 직접 설계했습니다. 단순한 속도 개선이 아니라 무인 실행과 고객별 요구사항의 유연한 대량 반영을 함께 만든 운영체계입니다.",
      steps: [
        {
          label: "01 · ANALYZE",
          title: "수작업 병목 직접 분석",
        ...
        },
        {
          ...
          title: "고객별 변형도 대량 적용",
          description:
            "고객사와 협의한 키워드 방향, 문체, 포함 내용과 시즌 이슈를 설정과 제작 규칙에 바로 반영하고, 변형된 버전도 같은 흐름으로 대량 제작했습니다.",
        },
      ],
    },
    evidence: [
    ...
    results: [
      ...
      "프로그램을 직접 조정할 수 있어 고객별 키워드·문체·포함 내용과 시즌 이슈를 즉시 변형하고, 변경된 버전도 대량 제작해 발행 지연과 품질 관련 클레임을 크게 줄였습니다.",
    ],
    proofs: [
      {
        title: "콘텐츠 제작·검수 통합앱",
