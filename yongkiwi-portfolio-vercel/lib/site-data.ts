...
export const careers = [
  {
    ...
    description:
      "50~60개 고객사를 담당하며 업체 대표와 콘텐츠 방향, 업종별·시즌별 키워드와 세부 요구사항을 직접 협의하고 수정·클레임에 대응합니다. 2025년 10월부터 내부 자동화 도구를 실무에 적용했고, 11월부터 현재 수준의 발행량과 검색 노출 성과를 운영하고 있습니다.",
  },
  {
...
export const selectedBackground = [
  ...
  },
  {
    ...
    description:
      "Google Analytics를 기반으로 데이터를 해석하고 성과를 측정하는 역량을 보완했습니다.",
  },
] as const;
...
export const projects: Project[] = [
  {
    ...
    judgment:
      "원고 생성 속도만 높여서는 문제가 해결되지 않습니다. 고객의 요구를 정확히 이해하고 실제 콘텐츠에 반영할 시간이 확보되어야 했고, 키워드 입력부터 원고·제목, 이미지, 품질 검수와 결과 정리까지 전체 흐름을 하나의 운영체계로 바꿔야 했습니다.",
    execution: [
    ...
    results: [
      ...
      "업체별 중간 방향 수정과 세부 요구를 빠르게 반영할 수 있게 되어 발행 지연과 품질 관련 클레임을 크게 줄이고, 발생한 이슈에도 직접 대응했습니다.",
    ],
    proofs: [
      {
  ...
  },
  {
    ...
    shortTitle: "키워드 리서치와 통제 실험으로 구축한 네이버 콘텐츠 SEO 시스템",
    title: "검색 수요를 찾고 콘텐츠를 실험해, 네이버 상위 노출을 개선했습니다.",
    summary:
      "검색량·경쟁도 기반 키워드 리서치부터 상위 검색결과(SERP) 분석, 콘텐츠 실험과 성과 측정까지 하나의 네이버 콘텐츠 SEO 사이클로 구축했습니다. 상위 노출 수·신규 진입·탈락·가중 점수와 월 진입률을 직접 기록하며 TOP 7 진입률을 30~40%에서 70~80% 수준으로 높였습니다.",
    brief: {
      challenge: "검색 수요와 경쟁도를 확인하지 못한 채 키워드를 사용했고, 발행 후 성과도 체계적으로 기록·분석하지 않아 콘텐츠 TOP 7 진입률이 30~40%에 머물렀습니다.",
      ...
      outcome: "다양한 콘텐츠 변수를 반복 검증하고, 그중 판단 근거가 명확한 대표 사례 3건을 공개합니다. 이를 포함한 운영 개선으로 콘텐츠 TOP 7 진입률을 70~80% 수준으로 높였습니다.",
    },
    ...
    metrics: [
      ...
      { label: "상세 공개 A/B 사례", value: "대표 3건" },
      { label: "세 공개 사례의 A·B 표본", value: "합계 1,480건" },
    ],
    problem: [
      "기존에는 키워드별 조회수와 경쟁도를 확인할 수 없었습니다.",
      "검색량이 없거나 경쟁 가능성이 낮은 키워드까지 콘텐츠에 사용했습니다.",
      "발행량은 확보했지만 상위 노출 수, 신규 진입과 탈락, 노출 가치가 체계적으로 기록되지 않아 어떤 선택이 성과로 이어지는지 판단하기 어려웠습니다.",
      "네이버 스마트블록과 검색 결과 구성이 반복적으로 바뀌었습니다.",
    ],
    judgment:
      "이 업무의 본질은 단순 블로그 발행이 아니라 네이버 검색에서 발견될 가능성을 높이는 콘텐츠 SEO였습니다. 무엇을 발행할지와 어떻게 발행할지는 다른 문제였고, 개선을 반복하려면 결과를 읽을 측정 기준부터 필요했습니다. 키워드는 검색량과 경쟁도로 선별하고 콘텐츠 구성은 단일 변수 통제 실험으로 검증한 뒤, 두 결과를 주간 순위 데이터와 연결했습니다.",
    execution: [
      "키워드 리서치: 분석 프로그램으로 키워드별 검색량과 경쟁도를 수집·분석했습니다.",
      "키워드 전략: 실제 검색 수요와 콘텐츠 진입 가능성을 모두 충족한 키워드만 제작 시스템에 투입했습니다.",
      "성과 측정: 통합검색 콘텐츠 1~7위 키워드 수, 신규 진입·탈락, 조회수와 순위를 가중한 자체 점수, 업체별 월 발행량 기준 진입률을 정의해 기록했습니다.",
      "랭크 트래킹: 과거 발행 키워드까지 매주 다시 확인해 노출 변화와 이상 징후를 조기에 발견했습니다.",
      "SERP 분석·콘텐츠 최적화: 성과가 하락하면 네이버 상위 콘텐츠를 분석해 원고 구조, 제목, 이미지 수 등 콘텐츠 변수에 대한 가설을 세웠습니다.",
      "콘텐츠 최적화: 동일 업체·키워드·발행 시기 등 다른 조건을 맞추고 한 번에 하나의 변수만 변경했습니다.",
      "콘텐츠 최적화: 반복한 실험 가운데 아래에 상세히 공개한 대표 사례 3건에서는 A·B 변형안 합계 1,480건을 발행·추적해 4주 누적 TOP 7 진입률을 비교했습니다.",
    ...
    performanceTracking: {
      title: "발행만 하던 업무에, 성과를 읽는 기준부터 만들었습니다.",
      description:
        "상위 노출 여부를 한 번 확인하고 끝내지 않았습니다. 매주 같은 기준으로 키워드의 현재 위치와 교체 흐름을 기록하고, 검색 수요와 순위를 함께 반영한 점수로 노출의 양과 질을 분석했습니다.",
      metrics: [
        { label: "실제 운영 데이터", value: "24회 관측" },
        { label: "관찰 범위", value: "누적 75개 업체" },
        { label: "1회 자동 조사량", value: "7천대 → 1.2만" },
      ...
      dimensions: [
        {
          label: "01 · CURRENT",
          title: "상위 노출 키워드 수",
          description: "해당 주 네이버 통합검색 콘텐츠 영역 1~7위에 남아 있는 키워드의 절대량",
        },
        {
          label: "02 · FLOW",
          title: "신규 진입·탈락",
          description: "전주 대비 새로 진입한 키워드와 순위권에서 이탈한 키워드를 분리해 변화 원인을 확인",
        },
        {
          label: "03 · VALUE",
          title: "검색수요·순위 가중 점수",
      ...
      trend: [
        { label: "06.08", topSeven: 1829, newEntries: 513, dropouts: 384 },
        { label: "06.15", topSeven: 1158, newEntries: 307, dropouts: 978, status: "이상 징후 감지" },
        { label: "06.22", topSeven: 1131, newEntries: 300, dropouts: 327, status: "1주 내 대응" },
        { label: "06.29", topSeven: 1214, newEntries: 361, dropouts: 278 },
        { label: "07.07", topSeven: 1129, newEntries: 245, dropouts: 330 },
        { label: "07.13", topSeven: 1496, newEntries: 658, dropouts: 291, status: "후속 발행 반영" },
        { label: "07.21", topSeven: 2134, newEntries: 1072, dropouts: 434, status: "회복 흐름 확인" },
      ],
      note:
        "업체명과 개별 키워드는 제외하고 전체 집계만 표시했습니다. 신규·탈락 흐름으로 변화를 감지하고, 상위 콘텐츠 분석과 통제 실험을 거쳐 콘텐츠 규칙을 수정한 뒤 후속 발행 추이로 회복을 확인했습니다.",
    },
    evidence: [
    ...
    results: [
      "노출 여부만 단순 확인하던 업무에 주차별 TOP 7 키워드 수, 신규 진입·탈락, 검색수요·순위 가중 점수와 월 발행량 기준 진입률을 직접 설계해 기록·분석 체계를 만들었습니다.",
    ...
    measurement:
      "‘네이버 통합검색 콘텐츠 TOP 7 진입률’은 업체별 월 발행 키워드를 기준으로, 자사 콘텐츠가 통합검색 콘텐츠 영역 1~7위에 진입한 비율입니다. 주간 순위 리포트는 과거 발행 키워드까지 계속 재조사해 현재 상위 노출 키워드 수, 신규 진입·탈락과 검색수요·순위 가중 점수를 기록합니다. 30~40%에서 70~80%로의 개선은 키워드 선별 하나가 아니라 키워드 전략, 반복적인 콘텐츠 변수 실험, 순위 측정과 플랫폼 변화 대응을 함께 개선한 전체 운영 성과입니다. 운영 과정에서는 이미지, 원고 구조와 표현 방식 등 다양한 변수를 수차례 검증했으며, 아래에는 그중 통제 조건과 판단 근거가 명확한 대표 사례 3건을 공개합니다. 세 공개 사례에서는 동일 업체·키워드·발행 시기 등 다른 조건을 맞춘 뒤 변수 하나만 변경해 A·B 각 120~500건, 합계 1,480건을 발행했습니다. 각 변형안에 사용한 키워드는 4주간 주 1회 추적하고, 기간 중 한 번이라도 콘텐츠 TOP 7에 진입하면 1건으로 집계해 두 안의 4주 누적 진입률을 비교했습니다. 결과 확인 직후 프로그램 기본값과 사용법에 반영하거나 롤백했습니다. 70~80%는 2025년 11월 이후의 실제 운영 수준이며, 단일 하루가 아닌 후속 발행 추이로 판단했습니다.",
    learning:
      "콘텐츠 SEO 성과는 좋은 키워드 하나만으로 만들어지지 않았습니다. 무엇을 발행할지는 데이터로 선별하고, 어떻게 발행할지는 통제 실험으로 검증하며, 검색결과 변화에는 후속 데이터로 대응하는 운영체계가 함께 작동해야 했습니다.",
  },
  {
    ...
    improvementMethods: [
      {
        ...
        example:
          "동일 업체·키워드·발행 시기 등 다른 조건을 맞추고 이미지 수, 원고 엔진, 소제목 등 콘텐츠 변수 하나만 변경했습니다. 수차례 진행한 실험 중 아래에 상세히 공개한 대표 3건은 A·B 각 120~500건, 변형안 합계 1,480건을 발행한 뒤 4주 누적 TOP 7 진입률을 비교했습니다.",
      },
      {
