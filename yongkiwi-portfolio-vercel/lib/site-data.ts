export const commonMetrics = [
  ...
  {
    value: "수작업 → 시스템 운영",
    label: "여러 마케팅 업무를 자동화하고 10개월간 고도화",
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "대표 A/B 테스트 표본", value: "총 1,480건" },
    ],
    problem: [
    ...
    execution: [
      ...
      "노출 성과가 하락하면 상위 콘텐츠의 차이를 분석해 원고 구조, 제목, 이미지 수와 키워드 규칙에 대한 가설을 세웠습니다.",
      "동일 업체·키워드·원고 엔진·발행 시기 등 다른 조건을 맞추고 한 번에 하나의 변수만 바꿨습니다.",
      "대표 실험 3건은 변형안별 120~500건, 합계 1,480건을 발행해 통합검색 1~7위 진입률을 비교했습니다.",
    ...
    experiments: [
      {
        ...
        status: "채택",
        signal:
          "통합검색 1~7위 진입률이 40~50%대로 낮아졌고, 경쟁력 있는 키워드의 상위 콘텐츠에서 이미지가 많은 패턴이 반복적으로 보였습니다.",
        hypothesis:
      ...
      },
      {
        ...
        status: "롤백",
        signal:
          "여러 업체의 통합검색 1~7위 진입률이 50~60%대에 머물러 추가 개선 요소를 탐색했습니다.",
        hypothesis:
    ...
    results: [
      ...
      "대표 실험 3건에서 변형안 합계 1,480건을 발행해 한 가지 변수의 효과를 비교했습니다.",
    ...
    measurement:
      "통합검색 1~7위 진입률은 측정한 키워드를 네이버 통합검색에 검색했을 때 우리 콘텐츠가 전체 콘텐츠 중 1번째부터 7번째 안에 나타난 비율입니다. 대표 A/B 테스트 3건은 다른 조건을 맞추고 한 가지 변수만 변경해 A·B 각 120~500건, 총 1,480건을 발행했습니다. 콘텐츠가 4주 동안 순차 발행되고 먼저 발행된 콘텐츠의 순위도 다시 내려갈 수 있으므로 특정 하루의 스냅샷으로 판단하지 않았습니다. 각 변형안에 사용한 키워드를 주 1회씩 4주간 개별 추적하고, 4주 중 한 번이라도 우리 콘텐츠가 통합검색 1~7위에 나타난 키워드를 진입 1건으로 집계했습니다. 진입 건수를 해당 변형안 전체 키워드 수로 나눠 두 안의 진입률을 비교했으며, 결과 확인 직후 프로그램 기본값과 사용법에 반영하거나 롤백했습니다. 70~80%는 2025년 11월 이후의 실제 운영 수준이며, 동일한 순차 발행 특성을 고려해 단일 하루가 아닌 후속 발행 추이로 판단했습니다.",
    learning:
  ...
  },
  {
    ...
    shortTitle: "10개월간 실사용·고도화한 마케팅 운영 시스템",
    title: "필요한 도구가 없으면 만들고, 환경이 바뀌면 다시 작동하게 했습니다.",
    summary:
      "콘텐츠 제작·검수, 키워드 분석, 순위 측정, 이미지 처리, 플레이스 리뷰 수와 인스타그램 게시물 모니터링 등 현장에서 발견한 반복 업무를 직접 자동화했습니다. 일회성 개발이 아니라 10개월간 실사용하며 플랫폼 변화에 맞춰 지속 고도화했습니다.",
    role: "문제 정의 · 업무 자동화 · 실무 운영 · 유지보수",
    contribution: "기획·개발·테스트·운영·고도화 100%",
    operationPeriod:
      "2025.10 실사용 시작 · 10개월간 실제 업무에서 지속 운영·고도화",
    ...
    improvementMethods: [
      {
        ...
        example:
          "동일 업체·키워드·원고 엔진·발행 시기 등 다른 조건을 맞추고 이미지 수 등 한 가지 변수만 변경했습니다. 대표 실험 3건은 A·B 각 120~500건을 발행한 뒤 통합검색 1~7위 진입률을 비교했습니다.",
      },
      {
    ...
    evidence: [
      ...
      { label: "도구 운영", before: "일회성 작업", after: "10개월 실사용·고도화" },
    ...
    results: [
      ...
      "프로그램들은 2025년 10월부터 10개월간 실제 업무에서 반복 사용하며 안정화·고도화했습니다.",
    ...
    learning:
      "시스템 오너십은 프로그램을 만든 순간이 아니라 실제 업무에서 계속 성과를 내도록 운영할 때 완성됩니다. 성과 개선에는 통제 실험을, 기능 이상에는 근본 원인 분석을 적용해야 판단과 해결이 섞이지 않습니다. 문제를 가장 가까이에서 겪는 실무자가 개선 기준과 필요한 결과를 정의하고 변화에 맞춰 끝까지 고도화할 때, 작은 내부 도구도 조직의 일하는 방식을 바꿀 수 있습니다.",
  },
];
