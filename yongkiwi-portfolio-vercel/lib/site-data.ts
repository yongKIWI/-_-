...
export const projects: Project[] = [
  ...
  },
  {
    ...
    measurement:
      "‘네이버 통합검색 콘텐츠 TOP 7 진입률’은 측정 대상 키워드의 통합검색 결과에서 자사 콘텐츠가 콘텐츠 영역 상위 7개 결과 안에 진입한 비율입니다. 30~40%에서 70~80%로의 개선은 키워드 선별 하나가 아니라 키워드 전략, 콘텐츠 변수 실험, 순위 측정과 플랫폼 변화 대응을 함께 고도화한 전체 운영 성과입니다. 대표 콘텐츠 A/B 테스트 3회는 키워드 선별 효과를 비교한 실험이 아닙니다. 동일 업체·키워드·발행 시기 등 다른 조건을 맞춘 뒤 이미지 수, 원고 엔진, 소제목·인용구 등 콘텐츠 변수 하나만 변경해 A·B 각 120~500건, 합계 1,480건을 발행했습니다. 각 변형안에 사용한 키워드는 4주간 주 1회 추적하고, 기간 중 한 번이라도 콘텐츠 TOP 7에 진입하면 1건으로 집계해 두 안의 4주 누적 진입률을 비교했습니다. 결과 확인 직후 프로그램 기본값과 사용법에 반영하거나 롤백했습니다. 70~80%는 2025년 11월 이후의 실제 운영 수준이며, 단일 하루가 아닌 후속 발행 추이로 판단했습니다.",
    learning:
