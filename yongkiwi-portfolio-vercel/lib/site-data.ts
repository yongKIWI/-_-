...
export const projects: Project[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "콘텐츠 A/B 테스트", value: "변형안별 200건+" },
    ],
    problem: [
    ...
    execution: [
      ...
      "동일 업체·키워드·원고 엔진·유사 발행 시기를 통제하고 한 번에 하나의 변수만 바꿔, 각 변형안을 최소 200건씩 발행했습니다.",
      "변형안별 통합검색 1~7위 진입률을 비교해 우수안을 1주 이내 콘텐츠 제작 시스템의 운영 규칙으로 반영했습니다.",
    ...
    results: [
      ...
      "동일 조건에서 한 가지 변수만 바꾸고 변형안별 최소 200건을 발행하는 콘텐츠 A/B 테스트 기준을 정착시켰습니다.",
    ...
    proofs: [
      ...
      {
        title: "콘텐츠 A/B 테스트 결과표",
        description:
          "동일 조건에서 한 가지 변수만 바꾸고, 변형안별 통합검색 1~7위 진입률을 비교한 실험 기록이 들어갈 자리입니다.",
        captureGuide:
          "가장 근거가 선명한 실험 3~5개를 정리해 주세요. 실험명, 통제 조건, 변경 변수, A·B 표본 수, 각 진입 건수·진입률, 최종 채택안이 한 화면에 보이면 좋습니다. 아직 확인되지 않은 개선 수치는 넣지 않습니다.",
      },
      {
    ...
    measurement:
      "통합검색 1~7위 진입률은 측정한 키워드를 네이버 통합검색에 검색했을 때 우리 콘텐츠가 전체 콘텐츠 중 1번째부터 7번째 안에 나타난 비율입니다. 콘텐츠 A/B 테스트는 동일 업체·키워드·원고 엔진·유사 발행 시기를 맞추고 한 가지 변수만 변경해 변형안별 최소 200건을 발행하는 방식으로 진행했습니다. 70~80%는 2025년 11월 이후의 실제 운영 수준이며, 고객사별 콘텐츠가 하루 3~10건씩 순차 발행되는 특성을 고려해 단일 하루가 아닌 후속 발행 추이로 판단했습니다.",
    learning:
    ...
    improvementMethods: [
      {
        ...
        example:
          "동일 업체·키워드·원고 엔진·유사 발행 시기를 통제하고 이미지 수 등 한 가지 변수만 변경해, 각 변형안을 최소 200건씩 발행한 뒤 통합검색 1~7위 진입률을 비교했습니다.",
      },
      {
