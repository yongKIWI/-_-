...
export const projects: Project[] = [
  ...
  },
  {
    ...
    performanceTracking: {
      ...
      metrics: [
        { label: "실제 성과 추적 기간", value: "2025.11~2026.08" },
    ...
    proofs: [
      ...
      {
        title: "2025.11~2026.08 키워드 퍼포먼스 추적 대시보드",
        description:
          "2025년 11월부터 2026년 8월까지 TOP 7 키워드 수, 가중 점수, 신규 진입·이탈과 업체별 누적 성과를 주차 단위로 기록한 실제 리포트입니다.",
        image: {
          src: "/evidence/keyword-performance-dashboard.png",
          alt: "2025년 11월부터 2026년 8월까지 키워드 수, 가중 점수, 신규 진입과 이탈 추이를 정리한 KIWI 키워드 퍼포먼스 대시보드",
          caption:
            "2025.11~2026.08·누적 75개 업체 · 주차별 키워드 수·점수·신규·이탈 추적",
          width: 1512,
          height: 1380,
        },
      },
