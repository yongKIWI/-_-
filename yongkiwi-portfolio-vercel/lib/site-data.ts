...
export const projects: Project[] = [
  {
    ...
    results: [
      "현재 1인이 50~60개 고객사의 대표와 직접 소통하며 월 약 8,200건을 실제 발행·운영하고 있습니다.",
  ...
  },
  {
    ...
    judgment:
      "이 업무의 본질은 단순 블로그 발행이 아니라 네이버 검색에서 발견될 가능성을 높이는 콘텐츠 SEO였습니다. 무엇을 발행할지와 어떻게 발행할지는 다른 문제였으므로, 키워드는 검색량과 경쟁도로 선별하고 콘텐츠 구성은 단일 변수 통제 실험으로 검증한 뒤 두 결과를 순위 데이터와 연결했습니다.",
    execution: [
      "키워드 리서치: 분석 프로그램으로 키워드별 검색량과 경쟁도를 수집·분석했습니다.",
      "키워드 전략: 실제 검색 수요와 콘텐츠 진입 가능성을 모두 충족한 키워드만 제작 시스템에 투입했습니다.",
      "랭크 트래킹: 네이버 통합검색 콘텐츠 TOP 7 진입률을 지속적으로 추적해 변화 징후를 확인했습니다.",
    ...
    results: [
      "키워드 리서치, SERP 분석, 콘텐츠 실험, 순위 측정과 플랫폼 대응을 결합한 네이버 콘텐츠 SEO 체계를 구축해 통합검색 콘텐츠 TOP 7 진입률을 30~40%에서 70~80% 수준으로 높였습니다.",
