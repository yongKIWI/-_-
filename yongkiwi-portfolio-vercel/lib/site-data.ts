...
export const projects: Project[] = [
  ...
  },
  {
    ...
    experiments: [
      {
        ...
        decision:
          "이미지 15장안이 뚜렷하게 우세해 이후 콘텐츠 제작 시스템의 기본 발행 규칙으로 채택했습니다.",
      },
      {
        period: "2026.05 · 1주차",
        title: "소제목·인용구 테스트",
        ...
        difference: "B안 +1.7%p",
        decision:
          "두 안의 차이가 실무 규칙을 바꿀 만큼 크지 않다고 판단해 신규안을 롤백했습니다.",
      },
      {
        period: "2026.06 · 2주차",
        title: "원고 엔진 테스트",
        ...
        control:
          "동일 이미지 · 동일 키워드 · 동일 업체 조건 / 여러 업체에서 원고 엔진만 변경",
        variants: [
          {
            label: "A",
        ...
        decision:
          "신규 엔진의 우세를 확인해 자연스러움 중심 엔진을 콘텐츠 제작 시스템의 기본값으로 전환했습니다.",
      },
    ],
    evidence: [
    ...
    measurement:
      "통합검색 1~7위 진입률은 측정한 키워드를 네이버 통합검색에 검색했을 때 우리 콘텐츠가 전체 콘텐츠 중 1번째부터 7번째 안에 나타난 비율입니다. 대표 A/B 테스트 3건은 다른 조건을 맞추고 한 가지 변수만 변경해 A·B 각 120~500건, 총 1,480건을 발행했습니다. 각 진입률은 진입 건수를 해당 변형안 발행 건수로 나눠 계산했으며, 두 안을 동일한 주간 순위 조사 기준으로 비교했습니다. 70~80%는 2025년 11월 이후의 실제 운영 수준이며, 고객사별 콘텐츠가 하루 3~10건씩 순차 발행되는 특성을 고려해 단일 하루가 아닌 후속 발행 추이로 판단했습니다.",
    learning:
