...
export const projects: Project[] = [
  {
    ...
    decisionCase: {
      label: "CLIENT COMMUNICATION WORKFLOW",
      title: "전화 상담을 고객별 운영 기준으로 바꿨습니다.",
      description:
        "실제 고객 소통은 전화 중심이었기 때문에 대화 원문을 공개하는 대신, 상담 내용을 콘텐츠 운영에 반영하는 업무 흐름을 식별정보 없이 재구성했습니다.",
      steps: [
        {
          label: "01 · REQUEST",
          title: "목표와 요구사항 확인",
          description:
            "업체 대표와 주력 서비스, 콘텐츠에 담을 내용, 원하는 키워드 방향과 시즌별 이슈를 직접 협의했습니다.",
        },
        {
          label: "02 · INTERPRET",
          title: "요청을 실행 기준으로 해석",
          description:
            "고객의 표현을 그대로 전달하는 데서 끝내지 않고 검색 의도와 운영 가능성을 검토해 키워드군, 메시지와 우선순위를 정리했습니다.",
        },
        {
          label: "03 · APPLY",
          title: "고객별 제작 규칙으로 반영",
          description:
            "합의한 방향을 원고·제목·키워드·검수 기준에 반영하고, 반복 적용할 수 있도록 고객사별 운영 규칙으로 구조화했습니다.",
        },
        {
          label: "04 · FOLLOW-UP",
          title: "운영 중에도 계속 조정",
          description:
            "발행 중간의 방향 변경과 세부 수정 요청, 품질 관련 클레임을 직접 확인해 후속 콘텐츠와 운영 기준에 반영했습니다.",
        },
      ],
      disclosure:
        "실제 업무 방식을 기반으로 고객명·상호·키워드와 대화 원문을 제외해 재구성했습니다.",
    },
    evidence: [
    ...
    proofs: [
      ...
      },
      {
        title: "고객사별 배포 운영 로그",
        description:
          "업체별 일 발행 건수, 잔여 건수와 발행 종료일을 관리하며 실제 월간 운영량을 통제한 시트입니다.",
        image: {
          src: "/evidence/distribution-operation-log.png",
          alt: "여러 고객사의 날짜별 일 발행 건수와 잔여 건수, 발행 종료일을 기록한 배포 운영 로그",
          caption:
            "실제 운영 기록 · 업체별 일 발행량과 누적 배포 이력",
          width: 1910,
          height: 917,
        },
      },
  ...
  },
  {
    ...
    brief: {
      ...
      outcome: "다양한 콘텐츠 변수를 반복 검증하고, 그중 판단 근거가 명확한 대표 실험 3건을 정리했습니다. 이를 포함한 운영 개선으로 콘텐츠 TOP 7 진입률을 70~80% 수준으로 높였습니다.",
    },
    ...
    metrics: [
      ...
      { label: "대표 A/B 테스트", value: "3건" },
      { label: "대표 실험의 A·B 표본", value: "합계 1,480건" },
    ],
    problem: [
    ...
    proofs: [
      ...
      {
        title: "1~8월 키워드 퍼포먼스 추적 대시보드",
        description:
          "24회 관측 데이터를 바탕으로 TOP 7 키워드 수, 가중 점수, 신규 진입·이탈과 업체별 누적 성과를 주차 단위로 기록한 실제 리포트입니다.",
        image: {
          src: "/evidence/keyword-performance-dashboard.png",
          alt: "2026년 1월부터 8월까지 24회 관측한 키워드 수, 가중 점수, 신규 진입과 이탈 추이를 정리한 KIWI 키워드 퍼포먼스 대시보드",
          caption:
            "24회·누적 75개 업체 관측 · 주차별 키워드 수·점수·신규·이탈 추적",
          width: 1512,
          height: 1380,
        },
      },
  ...
  },
  {
    ...
    judgment:
      "단순 검색 자동화만으로는 부족했습니다. SERP 내 고객사 콘텐츠 식별, 통합검색 콘텐츠 영역 기준 순위 계산, 실패와 순위권 밖 구분, 엑셀 입력과 보고 문장 출력까지 한 번에 작동해야 실제 업무에 사용할 수 있었습니다.",
    execution: [
      ...
      "URL 키와 SERP 구성 변경 등 주요 플랫폼 변화 약 4회에 맞춰 수정했습니다.",
    ],
    evidence: [
  ...
  },
  {
    ...
    learning:
      "시스템 오너십은 프로그램을 만든 순간이 아니라 실제 업무에서 계속 성과를 내도록 운영할 때 완성됩니다. 콘텐츠 변수에는 통제 실험을, 기능 이상에는 근본 원인 분석을, 노출 구조 변화에는 SERP 전략 재설계를 적용해야 판단과 해결이 섞이지 않습니다. 문제를 가장 가까이에서 겪는 실무자가 개선 기준과 필요한 결과를 정의하고 변화에 맞춰 끝까지 운영·유지할 때, 작은 내부 도구도 조직의 일하는 방식을 바꿀 수 있습니다.",
  },
];
