export const commonMetrics = [
  {
    value: "4시간 → 약 50분",
    label: "90건 제작 · 원고·제목·이미지·검수를 자동 처리 (수정필요 51)",
    project: "operations-transformation",
    compact: true,
  },
  {
    value: "월 약 8,200건",
    label: "1인이 50~60개 고객사를 담당 (수정필요 52)",
    project: "operations-transformation",
    compact: true,
  },
  {
    value: "30~40% → 70~80%",
    label: "네이버 통합검색 콘텐츠 영역 1~7위 진입률 (수정필요 53)",
    project: "keyword-performance",
    compact: true,
  },
  {
    value: "10개월 · 추정 약 52만 회",
    label: "검색부터 순위 계산·보고까지 자동화 (수정필요 54)",
...
export const processSteps = [
  {
    title: "OBSERVE (수정필요 55)",
    korean: "문제 발견",
    description: "반복되는 병목과 고객의 불편을 업무 현장에서 찾습니다.",
  },
  {
    title: "DEFINE (수정필요 56)",
    korean: "기준 정의",
  ...
  {
    title: "OPERATE (수정필요 58)",
    korean: "실무 운영",
    description: "만든 도구를 실제 고객 업무에 적용하고 매주 사용합니다.",
  },
  {
    title: "IMPROVE (수정필요 59)",
    korean: "지속 개선",
...
export const careers = [
  {
    ...
    status: "재직 중",
    company: "웨이팅리스트",
    team: "네이버 콘텐츠 SEO·검색 마케팅팀 · 고객사 콘텐츠 운영·업무 자동화 (수정필요 60)",
    description:
...
export const selectedBackground = [
  {
    ...
    description:
      "광고 전략, 캠페인 기획, 미디어와 콘텐츠 관련 이론을 학습했습니다. (수정필요 61)",
  },
  {
    period: "2023 · 2024",
    status: "2회 수상",
    title: "KOSAC 챌린저상 (수정필요 62)",
  ...
  },
  {
    ...
    description:
      "Google Analytics 데이터 분석과 성과 측정 방법을 익히고 자격을 취득했습니다. (수정필요 63)",
  },
] as const;
...
export const projects: Project[] = [
  {
    ...
    shortTitle: "월 약 8,200건 운영에 사용하는 콘텐츠 제작 통합앱 (수정필요 64)",
    cardTitle: "1인이 월 약 8,200건을 운영하는 콘텐츠 제작 통합앱 (수정필요 65)",
    title: "반복 제작을 자동화해 야근과 발행 지연을 줄였습니다. (수정필요 66)",
    summary:
      "2~3명이 야근하며 월 약 2,000건을 처리하던 제작 업무를 자동화했습니다. 현재는 1인이 50~60개 고객사를 담당하며 월 약 8,200건을 운영하고 있으며, 8,200건은 최대치가 아닌 2025년 11월 이후의 실제 운영량입니다. (수정필요 67)",
    cardSummary:
      "원고·제목 생성, 이미지 처리, 품질 검수와 배포 관리를 한 앱에 연결했습니다. 자동 실행 중 확보한 시간은 고객 대응과 SEO 분석에 사용합니다. (수정필요 68)",
    brief: {
    ...
    role: "고객사 커뮤니케이션 · 콘텐츠 운영 · 업무 절차 개선 · 내부 도구 개발 (수정필요 69)",
    contribution: "1인 기획·개발·운영·유지보수 (수정필요 70)",
    operationPeriod:
      "2025.10 실사용 시작 · 2025.11 이후 현재 운영 수준 유지 (수정필요 71)",
    ...
    metrics: [
      ...
      { label: "90건 제작 · 기존 4시간 수작업", value: "약 50분 자동 실행 (수정필요 72)" },
    ...
    problem: [
      ...
      "발행 지연과 품질 편차로 수정 요청과 클레임 대응이 늘었습니다. (수정필요 73)",
    ],
    judgment:
      "제작 속도만 높여서는 고객 요청을 반영할 시간이 생기지 않았습니다. 키워드 입력부터 원고·제목 생성, 이미지 처리, 품질 검수와 결과 정리까지 이어지는 제작 절차가 필요했습니다. (수정필요 74)",
    execution: [
      "업체 대표와 직접 콘텐츠에 넣을 내용, 원하는 키워드 방향, 월별 이슈와 시즌 키워드를 협의했습니다.",
      "중간 방향 변경과 세부 수정 요청, 발행·품질 관련 클레임을 확인해 고객사별 작성 규칙에 반영했습니다. (수정필요 75)",
      "업무를 제작, 검수, 발행, 성과 확인 단계로 나눠 반복 작업과 오류 발생 지점을 확인했습니다. (수정필요 76)",
      "작업시간과 오류 빈도를 기준으로 자동화 순서를 정했습니다. (수정필요 77)",
      "실제 작업 조건, 예외 상황과 검수 기준을 정하고 Codex를 활용해 내부 업무용 프로그램으로 구현했습니다. (수정필요 78)",
      "고객사별 문체, 포함 내용과 키워드 규칙을 설정값으로 저장해 반복 적용했습니다. (수정필요 79)",
      "OpenAI API를 연동한 원고·제목 생성과 이미지 처리, 품질 검수를 한 작업 과정으로 연결했습니다. (수정필요 80)",
      "고객 업무에 적용한 뒤 수정 요청과 플랫폼 변화에 맞춰 기능을 보완했습니다. (수정필요 81)",
    ],
    decisionCase: {
      label: "제작 업무 개선 과정 (수정필요 82)",
      title: "반복 제작을 자동화하고 고객사별 설정을 대량 제작에도 적용했습니다. (수정필요 83)",
      description:
        "반복 수작업의 원인과 필요한 결과물을 정리해 프로그램을 만들었습니다. 90건 단위 제작을 자동 처리하면서도 고객사별 문체·키워드·포함 내용을 설정할 수 있게 구성했습니다. (수정필요 84)",
      steps: [
        {
          label: "01 · 업무 분석 (수정필요 85)",
          title: "시간이 오래 걸리는 단계 확인 (수정필요 86)",
          description:
            "원고·제목·이미지·검수 과정에서 시간이 반복 소모되고 오류와 발행 지연이 생기는 지점을 단계별로 정의했습니다.",
        },
        {
          label: "02 · 도구 제작 (수정필요 87)",
          title: "제작·검수 과정을 연결한 통합앱 구현 (수정필요 88)",
          description:
            "필요한 입력·출력, 예외 조건과 검수 기준을 직접 정하고 제작부터 후속 작업까지 연결되는 프로그램으로 구현했습니다.",
        },
        {
          label: "03 · 자동 실행 (수정필요 89)",
          title: "4시간 수작업을 약 50분 자동 실행으로 전환 (수정필요 90)",
          description:
            "사람이 약 4시간 처리하던 90건 제작을 약 50분의 무인 실행으로 전환해, 프로그램이 작동하는 동안 다른 업무를 수행할 수 있게 했습니다.",
        },
        {
          label: "04 · 고객사별 설정 (수정필요 91)",
          title: "고객사별 작성 규칙을 대량 제작에 적용 (수정필요 92)",
          description:
    ...
    results: [
      "90건 제작시간은 약 4시간에서 50분으로 줄었고, 자동 실행 중에는 다른 업무를 할 수 있게 됐습니다. (수정필요 93)",
      "확보한 시간은 고객 관리, 세부 요청 반영, 신규 고객 온보딩과 노출 전략 검토에 사용했습니다. (수정필요 94)",
      "고객별 키워드·문체·포함 내용과 시즌 이슈를 설정에 반영하고 변경된 버전도 대량 제작해 발행 지연과 품질 관련 클레임을 줄였습니다. (수정필요 95)",
    ],
    proofs: [
      {
        title: "콘텐츠 제작·검수 통합앱",
    ...
    learning:
      "자동 실행 중 확보한 시간을 고객 요청 반영과 노출 전략 검토에 사용하면서, 발행량과 고객사별 대응 범위를 함께 늘릴 수 있었습니다. (수정필요 96)",
  },
  {
    slug: "keyword-performance",
    category: "네이버 콘텐츠 SEO · A/B 테스트 (수정필요 97)",
    shortTitle: "키워드 선별·콘텐츠 실험·순위 추적을 연결한 네이버 콘텐츠 SEO (수정필요 98)",
    title: "검색 수요와 SERP를 분석해 통합검색 콘텐츠 영역의 상위 노출을 개선했습니다. (수정필요 99)",
    summary:
      "검색량과 경쟁도로 키워드를 선별하고, SERP 분석과 단일 변수 실험 결과를 콘텐츠 제작 규칙에 반영했습니다. 주간 순위 추적 결과 네이버 통합검색 콘텐츠 영역 1~7위 진입률은 30~40%에서 70~80% 수준으로 높아졌습니다. (수정필요 100)",
    cardSummary:
      "키워드 선별, 콘텐츠 실험과 주간 순위 추적을 연결하고, 성과 차이가 확인된 방식만 제작 규칙에 반영했습니다. (수정필요 101)",
    brief: {
    ...
    role: "네이버 콘텐츠 SEO · 키워드 선별 · 콘텐츠 실험 · 성과 분석 (수정필요 102)",
    contribution: "1인 분석 기준 수립·실험·운영·성과 검증 (수정필요 103)",
    operationPeriod:
      "2025.10 실사용 시작 · 2025.11 이후 70~80% 수준 유지 (수정필요 104)",
    ...
    cardMetric: {
      label: "네이버 통합검색 콘텐츠 영역 1~7위 진입률 (수정필요 105)",
      value: "30~40% → 70~80%",
    },
    metrics: [
      { label: "월 발행량 기준 1~7위 진입률 (수정필요 106)", value: "30~40% → 70~80%" },
      { label: "전체 고객사 합산 1~7위 키워드 · 주간 최고 (수정필요 107)", value: "7,248개" },
      { label: "단일 고객사 1~7위 키워드 · 주간 최고 (수정필요 108)", value: "248개" },
      { label: "주간 랭크 트래킹 자동 조사량", value: "1회 1만~1.2만 건" },
    ],
    problem: [
      "기존에는 키워드별 조회수와 경쟁도를 확인할 수 없었습니다.",
      "검색량이 없거나 경쟁 가능성이 낮은 키워드까지 콘텐츠에 사용했습니다.",
      "발행량은 확보했지만 SERP 내 상위 노출 키워드 수와 신규 진입·이탈을 기록하지 않아 어떤 선택이 성과로 이어지는지 판단하기 어려웠습니다. (수정필요 109)",
      "네이버 스마트블록을 비롯한 SERP 구성이 반복적으로 바뀌었습니다.",
    ],
    judgment:
      "검색 수요와 경쟁도를 확인해 키워드를 선별하고, SERP 상위 노출 콘텐츠에서 발견한 특징은 단일 변수 실험으로 검증했습니다. 변경 후 결과는 주간 순위 추적으로 확인했습니다. (수정필요 110)",
    execution: [
      "키워드 리서치: 분석 프로그램으로 키워드별 검색량과 경쟁도를 수집·분석했습니다.",
      "키워드 선별: 검색 수요가 있고 경쟁 가능성이 확인된 키워드만 콘텐츠 제작에 사용했습니다. (수정필요 111)",
      "성과 측정: 네이버 통합검색 콘텐츠 영역 1~7위 키워드 수, 신규 진입·이탈, 검색량과 순위를 반영한 내부 비교 점수, 업체별 월 발행량 기준 진입률을 기록했습니다. (수정필요 112)",
      "랭크 트래킹: 과거 발행 키워드까지 매주 다시 확인해 SERP 내 순위 변화와 이상 징후를 조기에 발견했습니다.",
      "성과가 떨어지면 타깃 키워드의 상위 노출 콘텐츠를 비교해 원고 구조, 제목과 이미지 수에서 반복되는 특징을 찾고 검증할 변수로 정했습니다. (수정필요 113)",
      "동일 업체·키워드·발행 시기 등 다른 조건을 맞추고 한 번에 하나의 변수만 변경했습니다.",
      "수차례 진행한 실험 중 아래 대표 3건에서는 A·B 변형안 합계 1,480건을 발행·추적해 4주 누적 1~7위 진입률을 비교했습니다. (수정필요 114)",
      "성과 차이가 분명한 방식은 콘텐츠 제작 기본값에 반영하고, 효과가 미미한 방식은 기존 설정으로 되돌렸습니다. (수정필요 115)",
      "변경된 콘텐츠가 순차 발행된 뒤 주간 데이터로 회복 추이를 확인했습니다. (수정필요 116)",
    ],
    experiments: [
      {
        period: "2026.03 · 2주차",
        ...
        status: "채택",
        signal:
          "통합검색 콘텐츠 영역 1~7위 진입률이 40~50%대로 하락한 시점에 타깃 키워드의 SERP를 다시 확인했습니다. 상위 노출 콘텐츠에서 많은 이미지가 반복적으로 확인돼 이미지 수를 실험 변수로 정했습니다. (수정필요 117)",
        hypothesis:
      ...
      },
      {
        ...
        status: "롤백",
        signal:
          "여러 업체의 통합검색 콘텐츠 영역 1~7위 진입률이 50~60%대에 머물러 추가로 바꿀 요소를 찾았습니다. (수정필요 118)",
        hypothesis:
          "타깃 키워드의 상위 노출 콘텐츠를 확인한 결과, 내돈내산·체험단형 콘텐츠에서 소제목과 인용구가 반복적으로 사용됐습니다. 해당 요소가 1~7위 진입률에 영향을 주는지 단일 변수 실험으로 확인했습니다. (수정필요 119)",
        control:
      ...
      },
      {
        ...
        status: "채택",
        signal:
          "일일 신규 진입 건수가 약 100건에서 30건 수준으로 급감한 뒤 타깃 키워드의 상위 노출 콘텐츠를 다시 분석했습니다. 광고성 표현과 반복적인 AI 문체가 적은 콘텐츠가 더 자주 확인돼 문체의 자연스러움을 실험 변수로 정했습니다. (수정필요 120)",
        hypothesis:
    ...
    experimentProtocol: [
      ...
      {
        label: "진입 판정",
        value: "4주 중 1회 이상 통합검색 콘텐츠 영역 1~7위 진입 (수정필요 121)",
      },
      {
        label: "운영 반영",
    ...
    performanceTracking: {
      title: "발행 후 성과를 매주 비교할 수 있는 지표를 정리했습니다. (수정필요 122)",
      description:
        "동일 키워드의 콘텐츠 영역 내 순위와 신규 진입·이탈을 매주 추적했습니다. 검색 수요와 순위에 가중치를 적용한 내부 점수는 키워드별 노출 우선순위를 비교하는 데 사용했습니다. (수정필요 123)",
      metrics: [
        { label: "실제 성과 추적 기간", value: "2025.12~2026.08" },
        { label: "관찰 범위", value: "누적 75개 업체" },
        { label: "1회 자동 조사량", value: "1만~1.2만 건" },
        { label: "월 발행량 기준 (수정필요 124)", value: "1~7위 진입률 70~80%" },
      ],
      dimensions: [
        {
          label: "01 · 상위 노출 키워드 (수정필요 125)",
          title: "콘텐츠 영역 1~7위 키워드 수 (수정필요 126)",
          description: "해당 주 네이버 통합검색 콘텐츠 영역 1~7위에 노출된 키워드 수 (수정필요 127)",
        },
        {
          label: "02 · 신규 진입·이탈 (수정필요 128)",
          title: "1~7위 신규 진입·이탈 (수정필요 129)",
          description: "전주 대비 1~7위에 새로 진입하거나 해당 영역에서 이탈한 키워드의 변동 규모를 확인 (수정필요 130)",
        },
        {
          label: "03 · 내부 비교 점수 (수정필요 131)",
          title: "검색 수요·순위 가중 점수 (수정필요 132)",
          description: "키워드 조회수와 1~7위 순위에 차등 가중치를 적용해 키워드별 노출 우선순위를 비교 (수정필요 133)",
        },
        {
          label: "04 · 진입률 (수정필요 134)",
          title: "월 발행량 기준 1~7위 진입률 (수정필요 135)",
          description: "업체별 월 발행 키워드 중 통합검색 콘텐츠 영역 1~7위에 진입한 비율 (수정필요 136)",
        },
      ],
      trend: [
      ...
      note:
        "대시보드는 개별 업체보다 전체 고객사의 주간 추세를 확인하는 데 사용했습니다. 신규 진입·이탈에서 이상 시점을 확인하고, SERP 분석과 통제 실험 결과를 콘텐츠 제작 규칙에 반영했습니다. 변경된 콘텐츠가 순차 발행된 뒤 회복 여부를 확인했습니다. (수정필요 137)",
    },
    evidence: [
      { label: "검색 수요 판단 (수정필요 138)", before: "확인 불가", after: "조회수 확인" },
      { label: "상위 노출 가능성 판단 (수정필요 139)", before: "감과 경험", after: "경쟁도 확인" },
      {
        label: "통합검색 콘텐츠 영역 1~7위 진입률 (수정필요 140)",
        before: "30~40%",
        after: "70~80%",
      },
    ],
    results: [
      "노출 여부만 확인하던 업무에 1~7위 키워드 수, 신규 진입·이탈, 검색 수요·순위 가중 점수와 월 진입률을 도입해 매주 기록했습니다. (수정필요 141)",
      "조회수가 있고 경쟁 가능성이 확인된 키워드만 발행하는 선별 기준을 실제 업무에 적용했습니다. (수정필요 142)",
      "이미지 수와 자연스러움 중심 원고 엔진은 채택하고, 효과가 미미했던 소제목·인용구 적용안은 롤백했습니다.",
      "검색 변화 감지, SERP 분석, 가설 수립, 통제 실험, 제작 규칙 변경과 후속 성과 확인을 반복했습니다. (수정필요 143)",
    ],
    proofs: [
      {
      ...
      },
      {
        ...
        description:
          "2025년 12월 추적을 시작해 2026년 8월까지 1~7위 키워드 수, 내부 비교 점수, 신규 진입·이탈과 업체별 누적 성과를 기록했습니다. 현재 대시보드는 2026년 1월 26일부터의 24개 관측 주차를 집계합니다. (수정필요 144)",
        image: {
    ...
    measurement:
      "진입률은 업체별 월 발행 키워드 중 자사 콘텐츠가 네이버 통합검색 콘텐츠 영역 1~7위에 한 번 이상 진입한 비율입니다. 주간 리포트에서는 기존 키워드까지 다시 조사해 1~7위 키워드 수, 신규 진입·이탈과 검색 수요·순위 가중 점수를 추적했습니다. 대표 실험 3건의 A·B 발행 표본은 합계 1,480건이며, 70~80%는 키워드 선별·콘텐츠 실험·순위 측정·플랫폼 대응을 함께 적용한 2025년 11월 이후 운영 수준입니다. (수정필요 145)",
    learning:
      "키워드 선별만 바꾸는 것으로는 충분하지 않았습니다. 콘텐츠 구성도 통제 실험으로 비교하고, 변경 후 순위를 매주 확인해야 성과 변화를 판단할 수 있었습니다. (수정필요 146)",
  },
  {
    slug: "rank-monitoring",
    category: "키워드 순위 측정 · 웹 자동화 (수정필요 147)",
    shortTitle: "10개월간 추정 약 52만 회를 조사한 키워드 순위 시스템 (수정필요 148)",
    cardTitle: "수작업 검색부터 보고 문장까지 자동화한 순위 조사 시스템 (수정필요 149)",
    title: "매주 반복하던 키워드 순위 조사와 보고를 자동화했습니다. (수정필요 150)",
    summary:
      "2명이 6~7시간 동안 3,000개 키워드를 조사하던 업무를 PC 2대가 약 4시간 동안 평균 9,500개를 자동 조사하는 방식으로 바꿨습니다. 10개월간의 추정 누적 조사량은 약 52만 회입니다. (수정필요 151)",
    cardSummary:
      "검색, 고객사 콘텐츠 식별, 순위 계산과 보고 문장 출력을 한 번의 실행으로 완료하도록 만들었습니다. 실행 중에는 다른 업무를 할 수 있습니다. (수정필요 152)",
    brief: {
    ...
    role: "업무 분석 · 웹 자동화 · 보고 형식 설계 · 유지보수 (수정필요 153)",
    contribution: "1인 기획·개발·테스트·운영·유지보수 (수정필요 154)",
    operationPeriod:
      "2025.10 실사용 시작 · 10개월간 주간 운영·플랫폼 변화 대응 (수정필요 155)",
    tools: ["Playwright", "Excel", "브라우저 자동화", "보고용 문장 생성 (수정필요 156)"],
    tags: ["Measurement", "Web Automation", "Reporting"],
    cardMetric: { label: "10개월 추정 누적 조사량 (수정필요 157)", value: "약 52만 회" },
    metrics: [
      { label: "1회 처리량", value: "3,000 → 평균 9,500" },
      { label: "기존 투입", value: "2명 × 6~7시간" },
      { label: "자동 실행", value: "2대 × 약 4시간" },
      { label: "추정 누적 조사량 (수정필요 158)", value: "약 52만 회" },
    ],
    problem: [
    ...
    judgment:
      "검색만 자동화해서는 보고 업무가 끝나지 않았습니다. SERP에서 고객사 콘텐츠를 식별하고 콘텐츠 영역 내 순위를 계산한 뒤, 검색 오류와 순위권 밖 결과를 구분해 보고 문장까지 생성해야 했습니다. (수정필요 159)",
    execution: [
    ...
    evidence: [
      { label: "조사 방식 (수정필요 160)", before: "2명 수작업", after: "PC 자동 실행" },
      { label: "1회 조사량", before: "3,000건", after: "평균 9,500건" },
      { label: "업무 형태", before: "직접 검색", after: "보고까지 자동" },
      { label: "조사 중 다른 업무 (수정필요 161)", before: "진행 어려움", after: "동시 수행 가능" },
    ],
    results: [
    ...
    learning:
      "검색 자동화만으로는 업무가 줄지 않았고, 고객사 콘텐츠 식별과 보고 문장 출력까지 연결해야 실제 투입시간을 줄일 수 있었습니다. (수정필요 162)",
  },
  {
    slug: "system-ownership",
    category: "업무 자동화 · 도구 운영·유지보수 (수정필요 163)",
    shortTitle: "10개월간 실무에 사용한 업무 자동화 도구 (수정필요 164)",
    title: "반복 업무를 자동화하고 플랫폼 변화에 맞춰 도구를 유지보수했습니다. (수정필요 165)",
    summary:
      "콘텐츠 제작·검수, 키워드 분석, 순위 측정, 이미지 처리와 각종 모니터링의 반복 작업을 자동화했습니다. 2025년 10월부터 업무에 사용했고 플랫폼 화면과 검색 구조가 바뀔 때마다 수정해 10개월간 사용을 이어왔습니다. (수정필요 166)",
    brief: {
    ...
    role: "반복 업무 분석 · 자동화 도구 구현 · 실무 적용 · 유지보수 (수정필요 167)",
    contribution: "1인 기획·개발·배포·운영·변화 대응 (수정필요 168)",
    operationPeriod:
      "2025.10 실사용 시작 · 10개월간 운영·플랫폼 변화 대응 (수정필요 169)",
    ...
    cardMetric: { label: "업무 방식 (수정필요 170)", value: "반복 수작업 → 자동화 도구 운영" },
    metrics: [
      { label: "개선 프로젝트 담당 범위 (수정필요 171)", value: "1인 기획·개발·운영" },
      { label: "실무 사용 기간 (수정필요 172)", value: "10개월" },
    ...
    problem: [
      ...
      "콘텐츠 제작·검수, 키워드 분석, 순위 조사, 이미지 처리와 각종 모니터링 업무 곳곳에 반복 수작업이 남아 있었습니다. (수정필요 173)",
      ...
      "한 번 만든 자동화도 플랫폼 변화와 오류에 맞춰 관리하지 않으면 실제 업무에서 계속 사용할 수 없었습니다. (수정필요 174)",
    ],
    judgment:
      "프로그램 수를 늘리기보다 반복 작업에 드는 사람의 시간을 줄이고, 필요한 결과를 바로 사용할 수 있으며 플랫폼 변경 후에도 수정해 사용할 수 있는지가 중요했습니다. (수정필요 175)",
    execution: [
      "콘텐츠 발행 업무를 수행하면서 반복적으로 시간이 소모되거나 오류가 발생하는 단계를 추가로 확인했습니다. (수정필요 176)",
      "도구마다 필요한 입력값, 결과물 형식과 정상 작동 기준을 먼저 정리했습니다. (수정필요 177)",
      "실제 작업 조건, 예외 상황과 검수 기준을 정하고 Codex를 활용해 업무용 프로그램으로 구현했습니다. (수정필요 178)",
      "콘텐츠 제작·검수, 키워드 분석, 순위 측정·보고, 이미지 처리와 모니터링 업무를 목적별 내부 도구로 만들었습니다.",
      "플레이스 리뷰 수와 인스타그램 게시물 수처럼 사람이 반복 확인하던 항목도 자동 수집·모니터링 방식으로 바꿨습니다. (수정필요 179)",
      "추가 가공 없이 사용할 수 있는 결과물을 만들고, 약 20분의 안내로 사용할 수 있도록 조작 절차를 줄였습니다. (수정필요 180)",
      "고객 업무에 적용한 뒤 오류, 사용 중 필요한 기능과 새로 발견된 반복 작업을 반영했습니다. (수정필요 181)",
      "콘텐츠 성과 저하는 통제 실험으로, 프로그램 오류는 원인 분석으로, 검색 노출 영역 변화는 키워드 전략 변경으로 대응했습니다. (수정필요 182)",
    ],
    improvementMethods: [
      {
        label: "콘텐츠 성과 대응 (수정필요 183)",
        title: "한 가지 변수만 바꿔 성과 비교 (수정필요 184)",
        description:
        ...
        steps: [
          ...
          "가설 수립",
          "단일 변수 A/B 테스트",
          "4주 누적 1~7위 진입률 비교 (수정필요 185)",
          "성과가 더 좋은 방식 반영 (수정필요 186)",
        ],
        example:
          "동일 업체·키워드·발행 시기 등 다른 조건을 맞추고 이미지 수, 원고 생성 규칙, 소제목 등 콘텐츠 변수 하나만 변경했습니다. 대표 실험 3건은 A·B 각 120~500건, 변형안 합계 1,480건을 발행한 뒤 4주 누적 1~7위 진입률을 비교했습니다. (수정필요 187)",
      },
      {
        label: "프로그램 오류 대응 (수정필요 188)",
        title: "오류 발생 구간을 확인해 로직 수정 (수정필요 189)",
        description:
          "성과 하락과 프로그램 오류를 구분하고, 결과 오염이나 실행 중단이 발생한 구간을 확인해 로직을 수정했습니다. (수정필요 190)",
        steps: [
          "이상 징후 감지",
          "영향 범위 확인",
          "오류 발생 구간 확인 (수정필요 191)",
          "예외·복구 로직 수정",
          "수정 전후 재검증",
          "재발 방지",
        ],
    ...
    decisionCase: {
      label: "플랫폼 변화 대응 사례 (수정필요 192)",
      title: "스마트블록 축소 후 키워드 선별 기준을 변경했습니다. (수정필요 193)",
      description:
        "플레이스 핵심 검색어에서 파생한 롱테일 키워드를 스마트블록에 노출하는 방식을 사용했습니다. 스마트블록 노출이 급격히 줄어든 뒤에는 해당 방식으로 상위 노출을 기대하기 어려워졌습니다. (수정필요 194)",
      steps: [
        {
          label: "01 · 변화 감지 (수정필요 195)",
          title: "노출 경로 변화 감지",
          description:
            "주간 랭크 트래킹에서 기존 키워드군의 상위 노출 수가 빠르게 감소하는 이상 징후를 확인하고 SERP 구성을 다시 점검했습니다.",
        },
        {
          label: "02 · 신규 발행 중단 (수정필요 196)",
          title: "기존 방식의 신규 발행 중단",
          description:
            "스마트블록 노출을 전제로 선별한 롱테일 키워드의 신규 발행을 중단했습니다. (수정필요 197)",
        },
        {
          label: "03 · 선별 기준 변경 (수정필요 198)",
          title: "SERP를 기준으로 키워드 경쟁 가능성 재평가 (수정필요 199)",
          description:
            "스마트블록 진입 가능성을 평가 기준에서 제외하고 검색 수요와 통합검색 상위 노출 콘텐츠의 경쟁 강도를 기준으로 키워드를 다시 선별했습니다. (수정필요 200)",
        },
        {
          label: "04 · 변경 후 추적 (수정필요 201)",
          title: "후속 발행으로 회복 확인",
          description:
            "상위 노출 가능성이 낮은 키워드를 제외한 뒤, 신규 진입·이탈과 내부 비교 점수를 매주 추적해 키워드 수의 회복 흐름을 확인했습니다. (수정필요 202)",
        },
      ],
      disclosure:
        "콘텐츠 노출 전략 변경과 프로그램 기능 오류 대응은 서로 다른 기준으로 구분했습니다. (수정필요 203)",
    },
    evidence: [
      { label: "반복 업무 개선 (수정필요 204)", before: "사람이 직접 확인", after: "자동 수집·처리" },
      { label: "도구 도입 전후 (수정필요 205)", before: "수작업", after: "자동화 도구 사용" },
      { label: "도구 사용 기간 (수정필요 206)", before: "도입 전", after: "10개월 실사용" },
      { label: "플랫폼 변경 대응 (수정필요 207)", before: "실행 오류·작업 중단", after: "수정 후 업무 재개" },
    ],
    results: [
      ...
      "약 20분의 안내로 사용할 수 있도록 구성했고, 실사용 과정에서는 업무 중단을 일으키는 충돌 없이 운영했습니다. (수정필요 208)",
    ],
    proofs: [
      {
    ...
    learning:
      "업무 자동화 도구는 제작 후에도 플랫폼 변화와 오류에 맞춰 관리해야 계속 사용할 수 있었습니다. 성과 하락, 기능 오류와 노출 영역 변화는 서로 다른 문제로 구분해 대응했습니다. (수정필요 209)",
  },
];
