...
이 프로젝트에는 Vercel Web Analytics 연결 코드가 포함되어 있습니다.
배포 후 Vercel 프로젝트 화면에서 `Analytics → Enable`을 한 번 누르면
다음 배포부터 방문 페이지와 유입경로를 확인할 수 있습니다.

속도 측정용 Speed Insights는 사용하지 않습니다.
